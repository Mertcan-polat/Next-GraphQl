This application has been prepared with GraphQl and NextJS for practical purposes. We get our requests from a fake API by creating a query within the application.
